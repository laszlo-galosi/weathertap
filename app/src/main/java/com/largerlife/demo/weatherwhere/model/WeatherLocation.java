...
public class WeatherLocation implements Parcelable {
     ...
     */
    public static double getUnitsIn(double rawValue, String paramName)
     ...
     */
    public static String getJSonParamValueByParamPath(final String paramPath,
     ...
     */
    public String getFormattedString(double metricValue, String paramName, String localized)
          throws IllegalArgumentException {
    ...
    public static class Builder {
        ...
        public WeatherLocation buildFromJson(final String jsonString)
            ...
            int uuid =
                  Integer.parseInt(getJSonParamValueByParamPath(Constants.PARAM_ID, jsonString));
            String placeName =
                  getJSonParamValueByParamPath(Constants.PARAM_LOCATION_NAME, jsonString);
            ...
            String weatherMain =
                  getJSonParamValueByParamPath(Constants.PARAM_WEATHER_MAIN, jsonString);
            String weatherDesc =
                  getJSonParamValueByParamPath(Constants.PARAM_WEATHER_DESC, jsonString);
            String weatherIcon =
                  getJSonParamValueByParamPath(Constants.PARAM_WEATHER_ICON, jsonString);
